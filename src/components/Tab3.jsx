...
const Tab3 = () => {
  return (
    <div className="shadow-md w-[80%] flex flex-col p-2 py-5 mx-auto border mt-[4rem] h-fit bg-white">
      <p className="text-xl font-medium mb-[3rem] text-gray-900">
        Enter Number Available to each Amenity
      </p>
      <ul className="flex flex-wrap justify-evenly w-full h-fit">
        <li className="flex bg-gray-200 p-1 items-center gap-3">
      ...
      <textarea
        name="desc"
        id="dessc"
        className="w-full mt-[2rem] p-3 resize-none min-h-[300px] rounded-md shadow-md border-2 text-3xl text-gray-600 border-black/40 outline-none placeholder:text-3xl"
