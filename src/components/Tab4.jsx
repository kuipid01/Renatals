...
const Tab4 = () => {
  return (
    <div className='shadow-md text-gray-600 w-[98%] md:w-[80%] flex flex-col p-2 py-5 mx-auto border mt-[4rem] h-fit md:h-[500px] bg-white'>
        ...
        <div className='flex w-full p-3 flex-col gap-3'>
            ...
            <div className='flex flex-wrap gap-5'>
                ...
                {
                    [0,1,2,3].map((item,index) => <div key={index} className='w-full md:w-[200px] flex flex-col border-solid shadow-md border-2  justify-center items-center  h-[200px]'>
                    {/* <AiOutlinePlus className='text-3xl font-bold '/>
