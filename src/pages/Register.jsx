...
const schema = yup
  .object({
    username: yup
      ...
      .min(3)
      .max(50)
      .required("Username is required and must be over 3 letters"),
...
const Register = () => {
  ...
  const onSubmit = async (data) => {
    ...
    try {
      ...
      // Assuming you have a /register endpoint for user registration
  ...
  return (
    <div className="w-full relative h-screen flex justify-between">
      <AiOutlineArrowLeft
        onClick={() => navigate(-1)}
        className="absolute z-[9999] left-4 top-4  cursor-pointer  text-3xl font-semibold text-secondary"
      />
            ...
            <div className="flex flex-col items-center gap-2">
              <div className="w-full relative">
                ...
                <input
                  ...
                  className="p-2 pl-[30px] md:text-gray-600 py-2 text-white md:py-auto md:pl-5 bg-gray-300/20 border-2 border-white rounded-md  px-2 md:border-b-2 w-full md:border-gray-400 outline-none"
                  {...register("email")}
                />
              </div>
