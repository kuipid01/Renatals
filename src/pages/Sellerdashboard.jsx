...
const Sellerdashboard = () => {
  ...
  return (
    <div className="w-full py-[7rem] bg-gray-100/50 min-h-screen  flex  justify-between px-[2rem] h-fit">
      ...
      {/* left side */}
      <div className="flex-1 ml-[2rem] h-fit">
        <div className="flex mb-[3rem] items-start justify-start p-2 border shadow">
          <button className="pb-2 border-b-4 border-secondary">
            Active Properties
          </button>
        </div>
        <div className="flex w-full flex-wrap gap-3 justify-start">
          {[1, 2, 3].map((item) => (
            <Link   key={item} to='/property/3'>
           
            <div
              className="w-[250px]  border cursor-pointer shadow h-[300px] flex flex-col "
            ...
            <Link to="/user/12/rental/new">
          <div className="w-[250px] border cursor-pointer  justify-center items-center gap-2 shadow h-[300px] flex flex-col ">
