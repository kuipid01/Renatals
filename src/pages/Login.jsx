...
const Login = () => {
  ...
  return (
    <div className="w-full relative h-screen flex justify-between">
     <AiOutlineArrowLeft onClick={() => navigate(-1)} className='absolute z-[9999] left-2 top-2 text-2xl cursor-pointer font-semibold text-secondary'/>
      ...
      <div className="flex w-1/2 flex-col gap-10  justify-center items-center">
        <h1 className="uppercase text-primary text-5xl font-bold">Sign In</h1>
        <form
       ...
       <p className="w-full text-center text-base">Don't have an account  <Link to='/register ' className="font-bold  text-lg text-primary"> Sign Up now</Link> </p>
